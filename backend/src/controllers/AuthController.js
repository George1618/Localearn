...
async function login(req, res) {
    ...
    console.log('Token JWT recebido:', idToken); // Pra verificar se o token é recebido corretamente
    ...
    try {
        ...
        console.log('Token JWT verificado:', uid); // Pra verificar se o token é verificado corretamente
